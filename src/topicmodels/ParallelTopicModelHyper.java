...
public abstract class ParallelTopicModelHyper implements Serializable {
    ...
    /**
     * Set or reset the number of topics. This method will not change any
     * token-topic assignments, so it should only be used before initializing or
...
//				logger.info("interation: " + iteration);
            ...
            if (iteration % 10 == 0) {
                if (printLogLikelihood) {
                    logger.info("<" + iteration + "> perplexity LL/token: " + formatter.format(perplexity()));
